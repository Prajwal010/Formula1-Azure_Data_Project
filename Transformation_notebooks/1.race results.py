...
# MAGIC %md
# MAGIC ####Reading files from processed
...
# MAGIC %md
# MAGIC Results data was incrementally loaded hence filtering with file date
...
circuits_races_df = circuits_df.join(races_df, races_df.circuit_id == circuits_df.circuit_id, 'inner')\
...
race_results_df = results_df.join(circuits_races_df, circuits_races_df.race_id == results_df.result_race_id)\
